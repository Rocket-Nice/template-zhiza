...
<div class="withEvotorBanner triangle-style <?= !$image ? ('__without-photo') : '' ?>">
    <picture class="triangle">
        <source srcset="/wp-content/themes/evotor/assets/images/triangle-tablet.svg"
                width="594" height="284" media="(max-width: 991px) and (min-width: 576px)">
        <source srcset="/wp-content/themes/evotor/assets/images/triangle.svg"
                width="240" height="239" media="(min-width: 992px)">
        <source srcset="/wp-content/themes/evotor/assets/images/triangle-mobile.svg"
                media="(max-width: 668px)">
        <img src="/wp-content/themes/evotor/assets/images/triangle.svg" width="240" height="239"
    ...
    <div class="content-wrapper">
        ...
        <?php if ($otherFields['button_link']): ?>
            <div class="btn--wrapper btn--wrapper--black btn--wrapper--animated">
                <a href="<?= $otherFields['button_link'] ?>" class="btn btn-white"
