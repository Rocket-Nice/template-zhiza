...
<div class="withEvotorBanner fire-style <?= !$image ? ('__without-photo') : '' ?>">
    <picture class="fire <?php if ($image) { ?>have-img<?php } ?>">
        <source srcset="/wp-content/themes/evotor/assets/images/fire_banner-style_tablet.svg"
                width="594" height="284" media="(max-width: 991px) and (min-width: 576px)">
        <source srcset="/wp-content/themes/evotor/assets/images/fire_banner-style.svg"
                width="240" height="239" media="(min-width: 992px)">
        <source srcset="/wp-content/themes/evotor/assets/images/fire_banner-style-mobile.svg"
                width="240" height="239" media="(max-width: 668px)">
        <img src="/wp-content/themes/evotor/assets/images/fire_banner-style.svg" width="240" height="239"
    ...
    <div class="content-wrapper">
        ...
        <?php if ($otherFields['button_link']): ?>
            <div class="btn--wrapper btn--wrapper--outline-black btn--wrapper--animated">
                <a href="<?= $otherFields['button_link'] ?>" class="btn btn-outline-black"
