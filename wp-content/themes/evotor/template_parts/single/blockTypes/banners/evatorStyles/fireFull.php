...
<div class="withEvotorSingle fire-style">
    <picture class="fire <?php if ($image) { ?>have-img<?php } ?>">
        <source srcset="/wp-content/themes/evotor/assets/images/fire_banner-style_tablet.svg" width="594" height="284"
            media="(min-width: 401px) and (max-width: 992px)">
        <source srcset="/wp-content/themes/evotor/assets/images/fire_banner-style-mobile.svg" width="240" height="239"
            media="(max-width: 400px)">
        <img src="/wp-content/themes/evotor/assets/images/fire_banner-style_tablet.svg" width="240" height="239" alt=""
            loading="lazy" decoding="async" />
    </picture>

    <?php if ($image): ?>
        <div class="img-container">
            <img src="<?= $image[0] ?>" alt="<?= $otherFields['banner_title'] ?: '' ?>"
                title="<?= $otherFields['banner_title'] ?: '' ?>" width="<?= $image[1] ?>" height="<?= $image[2] ?>" />
        </div>
    <?php endif; ?>

    <div class="content-wrapper" <?php if (!$image): ?> style="max-width: unset; width: 100%;" <?php endif; ?>>
        ...
        <?php if ($otherFields['button_link']): ?>
            <div class="btn--wrapper btn--wrapper--outline-black btn--wrapper--animated">
                <a href="<?= $otherFields['button_link'] ?>" class="btn btn-outline-black" rel="nofollow noopener"
                    target="_blank">
