...
<div class="withEvotorSingle triangle-style">
    <picture class="triangle">
        <source srcset="/wp-content/themes/evotor/assets/images/triangle-mobile.svg" media="(max-width: 668px)">
        <img src="/wp-content/themes/evotor/assets/images/triangle-tablet.svg" width="240" height="239" alt=""
    ...
    <div class="content-wrapper" <?php if (!$image): ?> style="max-width: unset; width: 100%;" <?php endif; ?>>
        ...
        <?php if ($otherFields['button_link']): ?>
            <div class="btn--wrapper btn--wrapper--black btn--wrapper--animated">
                <a href="<?= $otherFields['button_link'] ?>" class="btn btn-white" rel="nofollow noopener" target="_blank">
