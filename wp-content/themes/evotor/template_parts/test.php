...
<div data-source="zhiza">
    <figure class="new_post_top">
        <img src="<?= replaceLocalDevAddressToProduction($main_thumb_url[0]) ?>" alt="" loading='lazy'>
    </figure>
...
<div class="original_post">
    <p>
        Источник: <a href="https://zhiza.evotor.ru" target="_blank">онлайн-журнал «Жиза»</a>
    </p>
</div>
